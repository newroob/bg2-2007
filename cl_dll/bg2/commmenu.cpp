...
//-----------------------------------------------------------------------------
/*void CCommMenu::OnTextChanged(KeyValues *data)
{
...
/*void CCommMenu::OnCommand( const char *command )
{
...
/*int CCommMenu::PlayerAddItem( int itemID, wchar_t *name, KeyValues *data ) 
{
...
/*void CCommMenu::SetPlayerNameText(const wchar_t *text )
{
