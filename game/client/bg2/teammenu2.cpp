...
void CTeamMenu2::Update( void )
{
	...
	if( m_iLightAKey < 0 ) m_iLightAKey = gameuifuncs->GetButtonCodeForBind( "slot1" );
	if( m_iMediumAKey < 0 ) m_iMediumAKey = gameuifuncs->GetButtonCodeForBind( "slot2" );
	if( m_iMediumBKey < 0 ) m_iMediumBKey = gameuifuncs->GetButtonCodeForBind( "slot3" );
	if( m_iHeavyBKey < 0 ) m_iHeavyBKey = gameuifuncs->GetButtonCodeForBind( "slot4" );
