...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_ATTACK );
...
//===========================
	...
	//BG2
	ADD_ACTIVITY_TO_SR( ACT_BG2_IRONSIGHTS_AIM );
	ADD_ACTIVITY_TO_SR( ACT_BG2_IRONSIGHTS_WALK );
	ADD_ACTIVITY_TO_SR( ACT_BG2_IRONSIGHTS_RECOIL );
	ADD_ACTIVITY_TO_SR( ACT_FORCE_STABLE );
	ADD_ACTIVITY_TO_SR( ACT_FORCE_STABLE_EMPTY );
	//
...
//===========================
	...
	ADD_ACTIVITY_TO_SR ( ACT_BG2_GESTURE_RELOAD_CARBINE );
	ADD_ACTIVITY_TO_SR ( ACT_BG2_GESTURE_RELOAD_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_BG2_CANNON_SHOOT );
	ADD_ACTIVITY_TO_SR ( ACT_BG2_CANNON_LEFT );
	ADD_ACTIVITY_TO_SR ( ACT_BG2_CANNON_RIGHT );
	ADD_ACTIVITY_TO_SR ( ACT_BG2_CANNON_IDLE );
