...
public:
	...
	//BG2 - Don't need flashlight stuff anymore. -HairyPotter
	...
	virtual void			GetStepSoundVelocities( float *velwalk, float *velrun, float *flduck );
	...
	virtual CBaseEntity		*GiveNamedItem( const char *szName, int Skin = 0, int iSubType = 0 ); //BG2 - Added Skin argument. -HairyPotter
