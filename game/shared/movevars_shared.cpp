...
ConVar	sv_backspeed	( "sv_backspeed", "0.55", FCVAR_ARCHIVE | FCVAR_REPLICATED, "How much to slow down backwards motion" );
ConVar	sv_sidespeed	( "sv_sidespeed", "0.75", FCVAR_ARCHIVE | FCVAR_REPLICATED, "How much to slow down sidestepping. Should be > sv_backspeed" );
//
